	...
	public partial class CadastroProdutos : System.Web.UI.Page
	{
		...
		protected void enviarButton_Click(object sender, EventArgs e)
		{
			try
			{
				...
				//Verificação da foto
				if (file == null || string.IsNullOrEmpty(file.FileName) || file == null)
				{
				...
				produto.MimeType = figuraFileUpload.PostedFile.ContentType;
		...
		protected void produtosRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			...
			if (idField != null)
			{
				...
				//atribuindo a imagem ao ocntrole Image
